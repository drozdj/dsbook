from metaflow import FlowSpec, step, Parameter, resources, conda_base, profile, catch
...
class ManyKmeansFlow(FlowSpec):
    ...
    @step
    def start(self):
        import scale_data_local
        docs = scale_data_local.load_yelp_reviews(self.num_docs,file_path='yelp_review_full_csv.tgz')
        self.mtx, self.cols = scale_data_local.make_matrix(docs)
